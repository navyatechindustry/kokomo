  ...
  createShader() {
    ...
    this.program = new Program(this.gl, {
      ...
      uniforms: {
        ...
        uGrayscale: { value: this.grayscale ? 1.0 : 0.0 },
      },
      transparent: true,
    });
    const img = new Image();
...
class App {
  ...
  constructor(
    ...
    this.onResize();
    this.createGeometry();
    this.createMedias(items, bend, textColor, borderRadius, font, grayscale);
    this.update();
...
export default function CircularGallery({
  ...
  }, [items, bend, textColor, borderRadius, font, scrollSpeed, scrollEase, grayscale]);
